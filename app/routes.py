...
from app.forms import RegistrationForm, EditProfileForm, PostForm, LoginForm, ResetPasswordRequestForm
...
from app.email import send_password_reset_emai
...
def index():
    ...
    prev_url = url_for('index', paage=posts.prev_num) \
